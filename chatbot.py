...
# (speed up training, reduce the loss <PAD>)
...
# Training 
batch_index_check_training_loss = 100 # check it every 100 batches 
batch_index_check_validation_loss = (len(training_questions) // batch_size // 2) - 1 # check it half of the number of batches
total_training_loss_error = 0
list_validation_loss_error = []
early_stopping_check = 0 # increment it when there's little improvement 
early_stopping_stop = 100 # stop training if early_stopping_check reaches this limit 
